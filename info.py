...
# Bot information
SESSION = environ.get('SESSION', 'ZinCloudBot')
API_ID = int(environ.get('API_ID', '21270676'))
API_HASH = environ.get('API_HASH', '7c7182a9427e55544afcf73579f308e8')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5741811199').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002340418492'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001516616161')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://crazyshivam7493_db_user:jCNxd3uKS0ETHDeG@cluster0.vgynjmm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "crazyshivam7493_db_user")
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', '-1001516616161') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Dragon_india')
